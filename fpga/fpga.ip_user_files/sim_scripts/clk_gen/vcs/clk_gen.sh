...
#
# Generated by Vivado on Sat Jan 08 23:27:35 +0100 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../fpga.srcs/sources_1/ip/clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../../fpga.srcs/sources_1/ip/clk_gen/clk_gen.v" \
  2>&1 | tee -a vlogan.log
