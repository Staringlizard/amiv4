...
set_property -dict { PACKAGE_PIN W7   IOSTANDARD LVCMOS33 } [get_ports { sysclk }]; #IO_L12P_T1_MRCC_14 Sch=gclk
#create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {sysclk}];
#create_clock -add -name sys_clk_pin -period 27.00 -waveform {0 13.00} [get_ports {sysclk}];
#create_clock -period 27.000 -name sys_clk_pin -waveform {0.000 13.000} [get_ports sysclk]

#create_clock -add -name ad9984a_pixel_clk -period 83.33 -waveform {0 41.66} [get_ports {ad9984a_pixel_clk}];
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN K18 IOSTANDARD TMDS_33} [get_ports tmds_red_n];
set_property -dict {PACKAGE_PIN L18 IOSTANDARD TMDS_33} [get_ports tmds_red_p];

set_property -dict {PACKAGE_PIN H19 IOSTANDARD TMDS_33} [get_ports tmds_green_p];
set_property -dict {PACKAGE_PIN G19 IOSTANDARD TMDS_33} [get_ports tmds_green_n];

set_property -dict {PACKAGE_PIN H17 IOSTANDARD TMDS_33} [get_ports tmds_blue_p];
set_property -dict {PACKAGE_PIN G17 IOSTANDARD TMDS_33} [get_ports tmds_blue_n];

set_property -dict {PACKAGE_PIN V8 IOSTANDARD TMDS_33} [get_ports tmds_clk_n];
set_property -dict {PACKAGE_PIN U8 IOSTANDARD TMDS_33} [get_ports tmds_clk_p];

set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { tempa }]; #IO_L9P_T1_DQS_14 Sch=ja[3]
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { tempb }]; #IO_L6N_T0_D08_VREF_14 Sch=ja[9]
...
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[3] }]; #IO_L1P_T0_AD4P_35 Sch=ain_p[15]
#set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { xa_n[1] }]; #IO_L2N_T0_AD12N_35 Sch=ain_n[16]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[2] }]; #IO_L2P_T0_AD12P_35 Sch=ain_p[16]

## GPIO Pins
## Pins 15 and 16 should remain commented if using them as analog inputs
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[7]  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[6]  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[5]  }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[4]  }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[3]  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[2]  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[1]  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { ad9984a_red[0]  }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]
...
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[7] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[6] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[5] }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[4] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[1] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_green[0] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]
...
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[7] }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[6] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]
set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[5] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[4] }]; #IO_L2P_T0_34 Sch=pio[26]
set_property -dict { PACKAGE_PIN T3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[3] }]; #IO_L2N_T0_34 Sch=pio[27]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[2] }]; #IO_L1P_T0_34 Sch=pio[28]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[1] }]; #IO_L3P_T0_DQS_34 Sch=pio[29]
set_property -dict { PACKAGE_PIN T2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_blue[0] }]; #IO_L1N_T0_34 Sch=pio[30]
...
set_property -dict { PACKAGE_PIN V2    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_hs }]; #IO_L5P_T0_34 Sch=pio[33]
#set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_hs }]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_property -dict { PACKAGE_PIN W3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_vs }]; #IO_L6N_T0_VREF_34 Sch=pio[34]
set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_oe }]; #IO_L6P_T0_34 Sch=pio[35]
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { ad9984a_pixel_clk }]; #IO_L12P_T1_MRCC_34 Sch=pio[36]
...
set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { sram_n_oe     }]; #IO_L10P_T1_D14_14 Sch=sram-oe
set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { sram_n_we     }]; #IO_L10N_T1_D15_14 Sch=sram-we
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS33 } [get_ports { sram_n_ce     }]; #IO_L9N_T1_DQS_D13_14 Sch=sram-ce


set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ad9984a_hs]
